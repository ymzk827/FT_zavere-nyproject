          ...
          <div class="row d-flex flex-wrap justify-content-between">
            ...
            <div class="col-lg-3 col-sm-6 pb-3">
              <div class="footer-menu">
                <img :src="mainLogo" alt="logo" class="img-fluid mb-2" />
                <p>
                ...
                <div class="social-links">
                  <ul class="d-flex list-unstyled">
                    <li><a href="#"><svg class="facebook"></svg></a></li>
            ...
            <div class="col-lg-3 col-sm-6 pb-3">
              <div class="footer-menu text-capitalize">
                ...
                <ul class="menu-list list-unstyled">
                  <li class="menu-item mb-1"><a href="#">Track Your Order</a></li>
                  <li class="menu-item mb-1"><a href="#">Returns Policies</a></li>
                  <li class="menu-item mb-1"><a href="#">Shipping + Delivery</a></li>
            ...
            <div class="col-lg-3 col-sm-6 pb-3">
              <div class="footer-menu contact-item">
                ...
                <p>
                  ...
                  <a href="mailto:yourinfo@gmail.com" class="text-decoration-underline">yourinfo@gmail.com</a>
                </p>
                <p>
                  If you need support? Just give us a call.
                  <a href="#" class="text-decoration-underline">+55 111 222 333 44</a>
                </p>
              </div>
            </div>
